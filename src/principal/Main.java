...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        List<Integer> tamanhos = new ArrayList<>(Arrays.asList(100));
               
        for (int PROBLEMA = 2; PROBLEMA <= 2; PROBLEMA++) {
                        ...
                        for (int i = 2; i <= 2; i++) {
                            ...
                            for (long seed : seeds) {
                                ...
                                if (PROBLEMA == 1) {
                                    ...
                                    bfi.lerDeArquivo("D:\\Paula - Arquivos\\Desktop\\instancias\\agendamento\\sch" + tamanho + "k" + i + ".txt");
                                    //D:\Paula - Arquivos\Desktop\instancias\agendamento
                                    ...
                                    if (ESTRUTURA_MEMORIA == 1) {
                                        if (METAHEURISTICA == 1) {
                                            ...
                                            System.out.println(Math.round(aux.snd()));
                                            });
                                        } else {
                                    ...
                                    tsi.lerDeArquivo("D:\\Paula - Arquivos\\Desktop\\instancias\\caixeiro\\cv" + tamanho + "k" + i + ".txt");
                            ...
                            System.out.println("USANDO OPERADOR? " + USAR_OPERADOR_POR_BLOCO);
